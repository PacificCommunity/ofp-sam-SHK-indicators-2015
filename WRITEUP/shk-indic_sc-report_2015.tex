...
Nevertheless, they represent over 200,000 observed sets over the past ten years (Table 1). To determine if a set encountered a whale shark in some way we used three criteria 1) was the set labelled as a whale shark associated set as recorded on the observer PS-2 form; 2) whether the set caught a whale shark – from the observer PS-3 form; or 3) was an interaction reported  -  from the observer GEN-2 form.
