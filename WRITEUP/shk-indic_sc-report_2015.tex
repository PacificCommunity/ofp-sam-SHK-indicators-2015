...
\hlgreen{Add general statement for other 3 indicators:} With the exception of blue shark, the high-CPUE indicator showed a more or less steady trends for all species in all regions. %JR
...
% 5JR edit  - yes, this was copied verbatim}\\
...
\input{shk-indic_sc-report_2015_figures-tables.tex}
%-------------------------------------------------------------------
%-------------------------------------------------------------------
%-------------------------------------------------------------------
