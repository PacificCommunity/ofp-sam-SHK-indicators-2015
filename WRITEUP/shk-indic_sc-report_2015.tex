...
\begin{itemize}
\item Blue shark CPUE is declining in both the north and south Pacific. Oceanic white tip continue to decline throughout the tropical waters of the WCPO. Silky shark CPUE exhibits high fluctuations throughout the study period.  

\item CPUE for the thresher shark complex, and Mako sharks in the south Pacific, appear to be in decline though the last years data points is based on relatively few data.  

\item Mako in the north Pacific is subject to missing data for some years. Despite this trends in CPUE appeared relatively stable between 2000 and 2010, but no inference is possible for the last 4 years.

\item Porbeagle shark CPUE experienced a large decrease early on in the study period followed by a fluctuating but increasing CPUE trend.
...
Based on the indicators examined in this analysis recommendations to the Scientific Committee are: 
...
\begin{itemize}
\item The key shark species of greatest concern are blue shark; oceanic whitetip 

\item Mako shark in the south Pacific and the Thresher shark complex  
