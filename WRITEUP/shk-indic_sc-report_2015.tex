...
\section{Distribution Indicator Analyses}
    ...
    % 
In addition to the life stage and sex plots the proportion of positve sets by region and the proportion of 5degree squares having CPUE greater than 1 shark per 1000 hooks was calculated by region for each species.
    

      \subsection{Results}
      
\hlam{With the exception of blue shark the high-CPUE indicator more or less steady trends for all species in all regions, however this analysis was hampered by the lack of data throughout the region for species.  Notably the proportion of high-CPUE cells for blue shark was decreasing thought the study period for regions 3,5,and 6 with steady or slightly decreasing trends in region 3 and 4, region 1 was data deficient. 

For blue shark the  percentage of positive sets  indicator for blue shark showed the opposite trends than the high-CPUE indicator,namely increases in regions 3,5, and 6 with steady trends in regions 2 and 5. 
...
\hlam{- Observer records of hammerhead sharks that include sex and length were extremely limited, the samples were proportionally more juvenilles in the tropical waters around Paupa New Guinea and Fiji.
