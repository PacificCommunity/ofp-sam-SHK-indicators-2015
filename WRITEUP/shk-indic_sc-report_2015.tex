...
% DISTRIBUTION MAPS
\addcenterfig[for the WCPFC convention area.]{fig:map}{../GRAPHICS/Defined/IA_01_LL_spec_dist_BSH_LTB}

\addcenterfig[for the WCPFC convention area.]{fig:map}{../GRAPHICS/Defined/IA_02_LL_spec_dist_FAL_LTB}

\addcenterfig[for the WCPFC convention area.]{fig:map}{../GRAPHICS/Defined/IA_03_LL_spec_dist_HHD_LTB}

\addcenterfig[for the WCPFC convention area.]{fig:map}{../GRAPHICS/Defined/IA_04_LL_spec_dist_MAK_LTB}

\addcenterfig[for the WCPFC convention area.]{fig:map}{../GRAPHICS/Defined/IA_05_LL_spec_dist_OCS_LTB}

\addcenterfig[for the WCPFC convention area.]{fig:map}{../GRAPHICS/Defined/IA_06_LL_spec_dist_POR_LTB}

\addcenterfig[for the WCPFC convention area.]{fig:map}{../GRAPHICS/Defined/IA_07_LL_spec_dist_THR_LTB}

\clearpage
\addcenterfig[for the WCPFC convention area.]{fig:map}{../GRAPHICS/Defined/IA_08_LL_pcntpos_allreg_allspp_RDS_updated}

\addcenterfig[for the WCPFC convention area.]{fig:map}{../GRAPHICS/Defined/IA_09_LL_HIGH_CPUE_ALLSPP_RDS_updated}
...
\centering
   ...
   \begin{subfigure}[b]{0.6\textwidth}
       ...
       \label{fig:test2}
   \end{subfigure}
\caption{Blue Shark: Proportion of adult and juvenile}
\label{fig:test} 
\end{figure}
\end{landscape}
...
\addcenterfig[for the WCPFC convention area.]{fig:map}{../GRAPHICS/Defined/BSH.north_MU~yy+program_code + HPBCAT2 + mm + sharkbait_SIGMA~program_code + HPBCAT2 + mm_CPUE-stdz}

\addcenterfig[for the WCPFC convention area.]{fig:map}{../GRAPHICS/Defined/BSH.south_MU~yy+flag + HPBCAT2 + mm + sharkbait_SIGMA~intrcpt_CPUE-stdz}

\addcenterfig[for the WCPFC convention area.]{fig:map}{../GRAPHICS/Defined/MAK.north_MU~yy+program_code + mm + sharkbait_SIGMA~HPBCAT2_CPUE-stdz}

\addcenterfig[for the WCPFC convention area.]{fig:map}{../GRAPHICS/Defined/MAK.south_MU~yy+program_code + HPBCAT2 + mm + sharkbait_SIGMA~program_code + mm_CPUE-stdz}

\addcenterfig[for the WCPFC convention area.]{fig:map}{../GRAPHICS/Defined/FAL_MU~yy+program_code + HPBCAT2 + mm + sharkbait_SIGMA~program_code + sharkbait + mm_CPUE-stdz}

\addcenterfig[for the WCPFC convention area.]{fig:map}{../GRAPHICS/Defined/OCS_MU~yy+program_code + HPBCAT2 + mm + sharkbait_SIGMA~program_code_CPUE-stdz}

\addcenterfig[for the WCPFC convention area.]{fig:map}{../GRAPHICS/Defined/THR_MU~yy+program_code + HPBCAT2 + mm_SIGMA~HPBCAT2 + program_code_CPUE-stdz}

\addcenterfig[for the WCPFC convention area.]{fig:map}{../GRAPHICS/Defined/HHD_MU~yy+program_code + HPBCAT2 + mm + sharkbait_SIGMA~sharkbait_CPUE-stdz}

\addcenterfig[for the WCPFC convention area.]{fig:map}{../GRAPHICS/Defined/POR_MU~yy + flag + HPBCAT2 + mm_SIGMA~flag + mm_CPUE-stdz}

\clearpage
\subsubsection{CPUE Standardisation Diagnostics}

\addcenterfig[for the WCPFC convention area.]{fig:map}{../GRAPHICS/Defined/BSH.north_MU~yy+program_code + HPBCAT2 + mm + sharkbait_SIGMA~program_code + HPBCAT2 + mm_resids}

\addcenterfig[for the WCPFC convention area.]{fig:map}{../GRAPHICS/Defined/}
...
\addcenterfig[for the WCPFC convention area.]{fig:map}{../GRAPHICS/Defined/BI_01_LLSexRatio_RDS}

\addcenterfig[for the WCPFC convention area.]{fig:map}{../GRAPHICS/Defined/BI_02_bio_len_BSH_RDS}

\addcenterfig[for the WCPFC convention area.]{fig:map}{../GRAPHICS/Defined/BI_03_bio_len_FAL_RDS}

\addcenterfig[for the WCPFC convention area.]{fig:map}{../GRAPHICS/Defined/BI_04_bio_len_HHD_RDS}

\addcenterfig[for the WCPFC convention area.]{fig:map}{../GRAPHICS/Defined/BI_05_bio_len_MAK_RDS}

\addcenterfig[for the WCPFC convention area.]{fig:map}{../GRAPHICS/Defined/BI_06_bio_len_OCS_RDS}

\addcenterfig[for the WCPFC convention area.]{fig:map}{../GRAPHICS/Defined/BI_07_bio_len_POR_RDS}

\addcenterfig[for the WCPFC convention area.]{fig:map}{../GRAPHICS/Defined/BI_08_bio_len_THR_RDS}


\addcenterfig[for the WCPFC convention area.]{fig:map}{../GRAPHICS/Defined/BI_09_ps_bio_len_FAL}

\addcenterfig[for the WCPFC convention area.]{fig:map}{../GRAPHICS/Defined/BI_10_ps_bio_len_OCS}


\clearpage


\addcenterfig[for the WCPFC convention area.]{fig:map}{../GRAPHICS/Defined/BI_11_len_stdz_Blue_RDS}

\addcenterfig[for the WCPFC convention area.]{fig:map}{../GRAPHICS/Defined/BI_12_len_stdz_Silky_RDS}

\addcenterfig[for the WCPFC convention area.]{fig:map}{../GRAPHICS/Defined/BI_13_len_stdz_Hammerhead_RDS}

\addcenterfig[for the WCPFC convention area.]{fig:map}{../GRAPHICS/Defined/BI_14_len_stdz_Mako_RDS}

\addcenterfig[for the WCPFC convention area.]{fig:map}{../GRAPHICS/Defined/BI_15_len_stdz_OceanicWhiteTip}

\addcenterfig[for the WCPFC convention area.]{fig:map}{../GRAPHICS/Defined/BI_16_len_stdz_Porbeagle_RDS}

\addcenterfig[for the WCPFC convention area.]{fig:map}{../GRAPHICS/Defined/BI_17_len_stdz_Thresher_RDS}

\addcenterfig[for the WCPFC convention area.]{fig:map}{../GRAPHICS/Defined/BI_18_len_stdz_coef_out}

\clearpage
\subsection{Management Considerations}

\addcenterfig[for the WCPFC convention area.]{fig:map}{../GRAPHICS/fate_ll_ps_obs_all_keysharks_wcpo}
\addcenterfig[for the WCPFC convention area.]{fig:map}{../GRAPHICS/fate_ll_obs_by_region}

\addcenterfig[for the WCPFC convention area.]{fig:map}{../GRAPHICS/fate_ll_obs_BSH}
\addcenterfig[for the WCPFC convention area.]{fig:map}{../GRAPHICS/fate_ll_obs_FAL}
\addcenterfig[for the WCPFC convention area.]{fig:map}{../GRAPHICS/fate_ll_obs_HHD}
\addcenterfig[for the WCPFC convention area.]{fig:map}{../GRAPHICS/fate_ll_obs_MAK}
\addcenterfig[for the WCPFC convention area.]{fig:map}{../GRAPHICS/fate_ll_obs_OCS}
\addcenterfig[for the WCPFC convention area.]{fig:map}{../GRAPHICS/fate_ll_obs_POR}
\addcenterfig[for the WCPFC convention area.]{fig:map}{../GRAPHICS/fate_ll_obs_THR}
