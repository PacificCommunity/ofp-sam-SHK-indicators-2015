...
\graphicspath{ {C:/WCPFC/shark indicators/SHK-indicators-2015/GRAPHICS/}
               {C:/WCPFC/shark indicators/SHK-indicators-2015/GRAPHICS/CPUE_std/}}

\usepackage[english]{babel}


  \reportauthor{Joel Rice\footnote{Joel Rice Consulting Ltd.}, Laura Tremblay-Boyer\footnote{Oceanic Fisheries Programme, Secretariat of the Pacific Community}, and Shelton Harley}
...
The status of the many  shark species, and in particular those designated as key shark species (\emph{ blue, mako, thresher, silky  and oceanic white tip sharks}) in the western and central Pacific Ocean (WCPO) underwent a comprehensive review in 2011 \citep{Clarke2011_a}. In that review a number of indicators were developed to inform on the status of those shark stocks and their response to fishing pressure. The indicators were developed around information available from operational-level data and included information on the geographic range of catches for each of the species considered; the catch composition and temporal trends in both catch rates and in key biological characteristics such as the mean size and sex ratio.



This study provides an update of many of those indicators and extends the species range to include hammer head and porbeagle sharks. 

related to the stocks general trend, whether it has changed from the previous indicator analysis and, in such cases where further analysis is proposed, it provides recommendations on how to undertake that analysis.  Uncertainty regarding any species population level mechanisims that drive any indivudal anlysis is qualitiatively expressed  by species and stock in order to represent the uncertainty in the underlying data. 
...
Follwoing a brief description of the available data in section \ref{sec:Data_Desc} A general description of each the indicators is given in sectin \ref{sec:Desc_Analysis}. This section contains a brief summary of the results and conclusions 


%\section{General Methods}
\section{Description of Data}\label{sec:Data_Desc}
...
\section{Description of Indicator Analyses} \label{sec:Desc_Analysis}
\subsection{Distribution Indicators}
...
\subsection{Observed Species Composition Indicator Analyses}
...
%  CPUE INDICATORS
%----------------------------------------------------------------------------------------
\subsection{Catch Per Unit Effort indicator analyses}
%      \subsection{Introduction}
...
\subsection{Biological indicator analyses}
%      \subsection{Introduction}
...
%\section{Appendices}
% 
\section{CPUE Indicators.  Model diagnostics and extra plots}
